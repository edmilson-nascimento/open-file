...
* Read file
  ...
  do times times .
    ...
    case sy-index .
      when 1 .
        open dataset file for input in text mode encoding default .
        subject = 'encoding default' .
      when 2 .
        open dataset file for input in text mode encoding non-unicode .
        subject = 'encoding non-unicode' .
      when 3 .
*        open dataset file for input in text mode with byte-order mark .
        subject = 'with byte-order mark' .
      when 4 .
        open dataset file for input in text mode with native linefeed encoding default .
        subject = 'with native linefeed' .
      when 5 .
        open dataset file for input in text mode with native linefeed encoding non-unicode .
        subject = 'native linefeed encoding non-unicode' .
      when 6 .
        open dataset file for input in text mode with smart linefeed encoding default.
        subject = 'with smart linefeed' .
      when 7 .
        open dataset file for input in text mode with smart linefeed encoding non-unicode.
        subject = 'with smart linefeed non-unicode' .
      when 8 .
        open dataset file for input in text mode with unix linefeed encoding default .
        subject = 'with unix linefeed default' .
      when 9 .
        open dataset file for input in text mode with unix linefeed encoding non-unicode .
        subject = 'with unix linefeed non-unicode' .
      when 10 .
        open dataset file for input in text mode with windows linefeed encoding default .
        subject = 'with windows linefeed' .
      when 11 .
        open dataset file for input in text mode with windows linefeed encoding non-unicode .
        subject = 'with windows non-unicode' .
      when others .
    endcase .
